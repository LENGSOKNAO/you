            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="single-features-ads first">
                  <img src="./src/img/icons/f-delivery.png" alt="" />
                  <h4>Free shipping</h4>
                  <p>
              ...
              <div className="col-lg-4">
                <div className="single-features-ads second">
                  <img src="./src/img/icons/coin.png" alt="" />
              ...
              <div className="col-lg-4">
                <div className="single-features-ads">
                  <img src="./src/img/icons/chat.png" alt="" />
            ...
            <div className="row">
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="single-box-item first-box">
                      <img src="./src/img/f-box-1.jpg" alt="" />
                  ...
                  <div className="col-lg-12">
                    <div className="single-box-item second-box">
                      <img src="./src/img/f-box-2.jpg" alt="" />
                      <div className="box-text">
              ...
              <div className="col-lg-6">
                <div className="single-box-item large-box">
                  <img src="./src/img/f-box-3.jpg" alt="" />
                  <div className="box-text">
                    <span className="trend-year">2019 Party</span>
                    <h2>Collection</h2>
